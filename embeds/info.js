...
client.on('ready', async () => {
  ...
  const rulesEmbed = new EmbedBuilder()
    .setColor(0x206694)
    .setAuthor({ name: 'Server Rules', iconURL: 'https://cdn.discordapp.com/attachments/986281342457237624/986282015278125157/886245b66dd1d5f5c2469737e58a24ca.png' })
  ...
  const guideEmbed = new EmbedBuilder()
    .setColor(0x206694)
    .setAuthor({ name: 'Matrix Guide', iconURL: 'https://cdn.discordapp.com/attachments/986281342457237624/986282015278125157/886245b66dd1d5f5c2469737e58a24ca.png' })
