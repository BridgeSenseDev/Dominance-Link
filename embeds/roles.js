  ...
  const embed = new EmbedBuilder()
    ...
    .addFields(
      ...
      },
      {
        ...
        value: '`-` <@&807955811250733076> | Was in guild for 6+ months\n`-` <@&910315929160781825> | Must have been staff for over a year\n`-` <@&817133925834162177>',
        inline: true,
      },
    );
