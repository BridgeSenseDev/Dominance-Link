...
client.on('ready', async () => {
  ...
  const verifyEmbed = new EmbedBuilder()
    ...
    .setAuthor({ name: 'Upvotes', iconURL: 'https://cdn.discordapp.com/attachments/986281342457237624/1029771493749559336/1375-upvote.png' })
    .setDescription('By upvoting our server, you will not only help support us but also receive a special role!\n`-` '
  ...
  const channel = client.channels.cache.get('757377294045282425');
