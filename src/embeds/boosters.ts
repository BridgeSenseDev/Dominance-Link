...
client.on('ready', async () => {
  ...
  const verifyEmbed = new EmbedBuilder()
    ...
    .setAuthor({
      name: 'Nitro Booster Perks',
      iconURL:
        'https://cdn.discordapp.com/attachments/986281342457237624/1029645929604718613/1477-boosterbadgesroll.gif'
    })
    .setDescription(
      '`-` <@&586753876066172943> role\n`-` Access to change your server nickname\n`-` Access to priority speaker\n`-` ' +
  ...
  const channel = client.channels.cache.get('982796960106938378') as TextChannel;
