...
client.on("ready", async () => {
  ...
  const notificationsEmbed = new EmbedBuilder()
    ...
    .setAuthor({
      ...
      iconURL:
        "https://cdn.discordapp.com/attachments/986281342457237624/1005133447712473108/notification-bell_1.png",
    })
  ...
  const gameModesEmbed = new EmbedBuilder()
    .setColor(config.colors.discordGray)
    .setAuthor({
      name: "Game mode Roles",
      iconURL:
        "https://cdn.discordapp.com/attachments/986281342457237624/1006054852381651034/DdNypQdN_400x400.png",
    })
    .setDescription(
      "Use the buttons below to select what game modes you like to play\nThese roles can be mentioned!",
    );
